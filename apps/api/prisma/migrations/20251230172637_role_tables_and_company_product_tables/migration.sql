...
*/
-- AlterTable
ALTER TABLE "Auth" ADD COLUMN     "deletedAt" TIMESTAMP(3),
ADD COLUMN     "isDeleted" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "userId" TEXT NOT NULL,
ALTER COLUMN "otp" DROP NOT NULL,
ALTER COLUMN "otpValidUntil" DROP NOT NULL;
...
-- AddForeignKey
ALTER TABLE "Company" ADD CONSTRAINT "Company_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "Seller"("id") ON DELETE CASCADE ON UPDATE CASCADE;
